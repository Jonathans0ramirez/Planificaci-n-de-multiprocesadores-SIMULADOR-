...
export const menuParagraphs = [
    ...
    "El objetivo de los dos simuladores desarrollados es mostrar el comportamiento de las caché y las tareas según el comportamiento del Single-Queue Multiprocessor Scheduling (SQMS).",
